...
const COLUMNS = [
  { key: "shippingNo", label: "Ship No", type: "text" },
  { key: "skuNo", label: "SKU", type: "text" },
  { key: "courier", label: "Courier", type: "text" },
  { key: "supplier", label: "Supplier", type: "text" },
  { key: "buyerAtSource", label: "Buyer", type: "text" },
  { key: "dateOfPurchase", label: "Buy Date", type: "date" },
  { key: "shape", label: "Shape", type: "text" },
  { key: "weight", label: "Wt (ct)", type: "number" },
  { key: "certificateNo", label: "Cert No", type: "text" },
  { key: "pricePerCaratUSD", label: "$/ct", type: "number" },
  { key: "gstPercent", label: "GST %", type: "number" },
  { key: "gstAmount", label: "GST Amt", type: "number", readOnly: true },
  { key: "buyPriceTotal", label: "Buy Total", type: "number", readOnly: true },
  { key: "purchaseCurrency", label: "Curr.", type: "text" },
  { key: "rateAtPurchase", label: "Rate", type: "number", readOnly: true },
  { key: "basePriceINR", label: "Base INR", type: "number", readOnly: true },
  { key: "correctionPriceUSD", label: "Corr. USD", type: "number" },
  { key: "actualRate", label: "Act. Rate", type: "number" },
  { key: "actualPriceINR", label: "Act. INR", type: "number", readOnly: true },
  { key: "marketPL", label: "Mkt P/L", type: "number", readOnly: true },
  { key: "markup", label: "Markup", type: "number" },
  { key: "sellPriceLocalCurrency", label: "Sell Local", type: "number", readOnly: true },
  { key: "localCurrency", label: "Local Curr.", type: "text" },
  { key: "typeOfExchange", label: "Bank", type: "bank" },
  { key: "paymentStatus", label: "Payment", type: "paymentStatus" },
  { key: "status", label: "Status", type: "status" },
  { key: "warehouse", label: "WH", type: "text" },
  ...
  { key: "priceRUB", label: "RUB", type: "number", readOnly: true },
  { key: "priceUSD", label: "USD", type: "number", readOnly: true },
  { key: "pricePerCt", label: "$/ct", type: "number", readOnly: true },
  { key: "rateRUB", label: "RUB Rate", type: "number", readOnly: true },
  { key: "location", label: "Location", type: "text" },
  { key: "laboratory", label: "Lab", type: "text" },
  { key: "length", label: "L (mm)", type: "number" },
  { key: "width", label: "W (mm)", type: "number" },
  { key: "height", label: "H (mm)", type: "number" },
  { key: "dateOfSale", label: "Sale Date", type: "date" },
  { key: "buyerName", label: "Buyer", type: "text" },
  { key: "saleAmount", label: "Sale Amt", type: "number" },
  { key: "saleCurrency", label: "Sale Curr.", type: "text" },
  { key: "rateOnDateOfSale", label: "Sale Rate", type: "number" },
  { key: "saleBaseINR", label: "Sale INR", type: "number", readOnly: true },
  { key: "marginality", label: "Margin", type: "number", readOnly: true },
  { key: "actualMarkup", label: "Act. MU", type: "number", readOnly: true },
  { key: "manager", label: "Manager", type: "text" },
  { key: "bonusPoints", label: "Bon. Pts", type: "number" },
  { key: "bonusAmount", label: "Bon. Amt", type: "number", readOnly: true },
  { key: "bonusRate", label: "Bon. Rate", type: "number" },
  { key: "bonusInLocalCurrency", label: "Bon. Local", type: "number", readOnly: true },
];
