...
export default function ProfitLossDrilldown({ typeName, meta, rows, onClose }) {
  ...
  return (
    <div
      ref={ref}
      className="mt-5 bg-white rounded-2xl border overflow-hidden"
    ...
    >
      ...
      >
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-[14px] font-semibold" style={{ color: meta.text }}>
            {typeName}
          </span>
          <span
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button
            onClick={onClose}
            className="flex items-center gap-1 px-3 py-1.5 text-[12px] font-medium rounded-lg border cursor-pointer font-[DM_Sans,sans-serif] transition-colors hover:bg-white"
            style={{ borderColor: meta.border, color: meta.text, background: "transparent" }}
          >
